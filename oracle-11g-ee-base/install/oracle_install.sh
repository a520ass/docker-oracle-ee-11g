...
wget -q -O linux.x64_11gR2_database_1of2.zip http://172.0.52.111/dockerfiles/linux.x64_11gR2_database_1of2.zip
echo 'Downloading linux.x64_11gR2_database_2of2.zip'
wget -q -O linux.x64_11gR2_database_2of2.zip http://172.0.52.111/dockerfiles/linux.x64_11gR2_database_2of2.zip
echo 'Unzipping'
